...
# -- Project information -----------------------------------------------------
project = "db-load-generator"
copyright = f"2020–{datetime.now().year}, Dynatrace LLC"
...
html_logo = "_static/db-load-generator.png"
...
html_theme_options = {
    "github_url": "https://github.com/dynatrace-oss/db-load-generator",
}
